...
Command2D::Command2D() : cv::Vec<double, 2>(0, 0) {}

Command2D::Command2D(double v, double w) : cv::Vec<double, 2>(v, w) {}

Command2D::Command2D(const Command2D & o) : cv::Vec<double, 2>(o) {}
