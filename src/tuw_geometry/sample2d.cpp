...
Sample2D::Sample2D() : Pose2D(), weight_ ( 0 ) {};
Sample2D::Sample2D ( const Sample2D& s ) : Pose2D ( s ), weight_ ( s.weight_ ) {};
Sample2D::Sample2D ( const Pose2D &p, double weight ) : Pose2D ( p ), weight_ ( weight ) {};
