...
public:
  StampedData() {}
  StampedData(const StampedData<T> & o) : stamp(o.stamp), tf(o.tf), info(o.info), data(o.data) {}
  StampedData(
  ...
  StampedData(const T & d, const std::string & info) : stamp(), tf(), data(d), info(info) {}
  StampedData(
